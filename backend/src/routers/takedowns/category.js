...
// const { Category } = require("../../db/models/takedown");
...
//       const category1 = await Category.findOneAndUpdate(
//         {
...
//       };
//       const category = await Category.find(query).sort({ date: -1 }).limit(10);
...
//     const category = await Category.find({ owner: req.authId });
